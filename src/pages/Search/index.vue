...
<script>
// import search from "@/store/search"; 这行引入出的问题，但是这报错有点奇怪了。。
...
export default {
  ...
  data() {
    return {
      searchParams: {
        ...
        // 默认的搜索条件
        order: "1:asc", //排序规则，排序是后台排序的，我们搜索的时候得给后台一个默认的排序规则
  ...
  methods: {
    getSearchInfo() {
      // this.$store.dispatch('getSearchInfo',{})  //这里传空对象是为了获取数据展示页面
